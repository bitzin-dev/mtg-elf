  ...
  return (
    <div className="flex h-screen w-full bg-portal-bg text-gray-200 font-sans overflow-hidden">
      ...
      <main className="flex-1 lg:ml-64 h-screen flex flex-col bg-portal-bg overflow-hidden relative w-full pb-20 lg:pb-0">
        <header className="m-4 mb-3 lg:m-6 lg:mb-4 h-auto py-4 lg:py-0 lg:h-24 rounded-[1.75rem] bg-[#07130c]/95 ring-1 ring-white/[0.055] backdrop-blur-xl flex flex-col md:flex-row items-start md:items-center justify-between px-4 lg:px-6 shrink-0 gap-4 relative z-[30]">
