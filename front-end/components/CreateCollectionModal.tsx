...
export const CreateCollectionModal: React.FC<CreateCollectionModalProps> = ({ 
  ...
  // Import Mode State
  const [importFormat, setImportFormat] = useState<'manabox' | 'moxfield' | 'ligamagic' | 'portal'>('ligamagic');
                ...
                <div className="space-y-6">
                    ...
                    {activeTab === 'create' && (
                        <div className="space-y-5">
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-1">Filtro da Coleção</label>
                    ...
                    {activeTab === 'import' && (
                        <div className="space-y-6">
                            <div className="grid grid-cols-2 gap-2">
                                {(['manabox', 'moxfield', 'ligamagic', 'portal'] as const).map(fmt => (
                                    <button
                                        key={fmt}
                            ...
                            <div className="border-2 border-dashed border-white/10 rounded-2xl p-10 flex flex-col items-center justify-center text-center hover:border-emerald-500/50 hover:bg-emerald-500/5 transition-all relative">
                                ...
                                {importedFile ? (
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-gray-600 text-[10px] uppercase tracking-widest">CSV ou TXT</p>
                                    </div>
                                )}
                            </div>
                    ...
                    <div className="space-y-3 pt-6">
                        <button 
                            ...
                            disabled={!name || (activeTab === 'create' && !filterValue) || (activeTab === 'import' && !importedFile) || isResolving}
